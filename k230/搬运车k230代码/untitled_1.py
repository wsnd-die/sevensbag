...
PIXELS_THRESHOLD = 30
AREA_THRESHOLD   = 30
IGNORE_RECT = (0, PICTURE_HEIGHT-30, 40, 30)   # 左下角忽略区域
...
def line_follow(gray_img, disp_img):
    ...
    # 发送角度 (A3 B3 angle_H angle_L FF)
    angle_int = int(filtered_angle * 100)
    angle_int = max(-32768, min(32767, angle_int))
    uart.write(bytearray([0xA3, 0xB3, (angle_int >> 8) & 0xFF, angle_int & 0xFF, 0xFF]))
    print(f"angle: {filtered_angle:.2f}")
